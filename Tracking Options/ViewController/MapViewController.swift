...
class MapViewController: UIViewController {
    ...
    @IBOutlet weak var selectedDate: UIToolbar!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector: #selector(newlocation), name: .newLocationSaved, object: nil)
    ...
    func getMapAnnotations(_ dict:[[String:Any]]) -> [Station] {
        ...
        for item in dict.enumerated() {
            ...
            annotation.title = locDict["activity"] as? String
